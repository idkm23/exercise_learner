...
//    public static final int RHAND_ID = 22;
//    public static final int LHAND_ID = 21;
//    public static final int RELBOW_ID = 20;
//    public static final int LELBOW_ID = 18;
//    public static final int RSHOULDER_ID = 14;
//    public static final int LSHOULDER_ID = 12;

    public static final float HAND_ELBOW_ROTATION_RATIO = .6f;
    public static final float HAND_ROTATION_OFFSET = .8f;
}
