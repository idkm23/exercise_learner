 ...
 *  to position camera according to key events.</p>
 * 
...
public class CameraOrbitController {
    ...
    public void placeCamera() {
		...
		Log.d("myNinja", "" + cameraTarget + " " + cameraAngle);

        SimpleVector camPos = new SimpleVector(0, 1f, camZ);
